...
//
//  Vendored into FERAL Companion (2026-05-15). MIT License — see
//  Sources/ThirdParty/FMDB/README.md for attribution.
//
//  The additions category links against the FMDatabase symbol shipped
//  inside the proprietary JWBle.framework. When that framework is not
//  present in Vendor/ (stub-mode build), this translation unit must
//  compile to empty or the link step fails with an undefined symbol
//  error. Gate the whole file behind __has_include(<JWBle/JWBle.h>).
#if __has_include(<JWBle/JWBle.h>)
...
#endif // __has_include(<JWBle/JWBle.h>)
